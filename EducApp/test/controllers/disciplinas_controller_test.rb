...
class DisciplinasControllerTest < ActionController::TestCase
  ...
  test "should create disciplina" do
    assert_difference('Disciplina.count') do
      post :create, disciplina: { nome: @disciplina.nome, professor_id: @disciplina.professor_id, reference: @disciplina.reference }
    end
  ...
  test "should update disciplina" do
    patch :update, id: @disciplina, disciplina: { nome: @disciplina.nome, professor_id: @disciplina.professor_id, reference: @disciplina.reference }
    assert_redirected_to disciplina_path(assigns(:disciplina))
  end
