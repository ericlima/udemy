...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { escola_id: @curso.escola_id, nome: @curso.nome, reference: @curso.reference }
    end
  ...
  test "should update curso" do
    patch :update, id: @curso, curso: { escola_id: @curso.escola_id, nome: @curso.nome, reference: @curso.reference }
    assert_redirected_to curso_path(assigns(:curso))
  end
